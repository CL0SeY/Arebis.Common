...
namespace Arebis.Logging.GrayLog.NetCore
{
    ...
    public abstract class GrayLogClient : IDisposable
    {
        ...
        protected GrayLogClient(string facility)
        {
            ...
            this.CompressionTreshold = 0; // Int32.Parse(ConfigurationManager.AppSettings["GrayLogCompressionTreshold"] ?? "0");
        }
        ...
        protected abstract Task InternallySendMessageAsync(byte[] uncompressedMessageBody);
